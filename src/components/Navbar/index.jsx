...
function Index(props) {
  ...
  return (
    <div>
      ...
      <aside class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
        <div class="px-3 py-4 overflow-y-auto h-screen rounded bg-gray-50 dark:bg-gray-800">
          <ul class="space-y-2">
            <li>
              <a
                href="#"
